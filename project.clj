(defproject my-shadow-reagent "0.1.0-SNAPSHOT"
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "my-shadow-reagent.core/mount-root"}
             :compiler
             {:main "my-shadow-reagent.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns my-shadow-reagent.repl}
